/*
This is a direct copy of ampersand-dom-bindings

Only difference is the binding option `firstMatchOnly` which tells
the getMatches method to use .querySelector instead of .querySelectorAll
hence retrieving only the first occurrence of the element.

Note that when a binding type is `toggle` the `selector` property
is ignored in favor of `yes` and `no` properties.
*/
/* $AMPERSAND_VERSION */
